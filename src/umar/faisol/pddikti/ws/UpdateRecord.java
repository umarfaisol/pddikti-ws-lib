...
public class UpdateRecord {
    public DefaultTableModel updateRecord(String token, String table, String ws, String isi) {
        ...
        try {
            ...
            QName bodyName = new QName("UpdateRecord");
            ...
            SOAPElement dataSoap = bodyElement.addChildElement(dataQname);
            dataSoap.addTextNode(isi);
